...
export function runMigrations() {
    ...
    var sql =
        'CREATE TABLE IF NOT EXISTS mol_table ( datum timestamp PRIMARY KEY NOT NULL ,date_day varchar(255),day_time varchar(255),  vyska_hladiny_ve_studni double, teplota_u_GPS_anteny double, tlak_u_GPS_anteny double,vlhkost_u_GPS_anteny double,uhrn_srazek double)';
    connection.query(sql);
    var sql =
